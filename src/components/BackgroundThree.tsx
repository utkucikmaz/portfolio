...
function clampDpr(dpr: number) {
  // Keep this ultra-lightweight on retina displays.
...
export default function BackgroundThree({
  isDarkMode,
}: BackgroundThreeProps): JSX.Element {
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      uMouse: { value: new THREE.Vector2(0.5, 0.5) }, // Mouse position 0..1
      uOpacity: { value: 1 },
    }
    ...
    const resize = () => {
      ...
      // Avoid doing expensive resize work if nothing actually changed.
